...
writes the exact commit SHA and UTC build timestamp into this module immediately
before PyInstaller runs so packaged artifacts remain self-identifying without a
.git directory.
"""
